...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        mensaje = "La temperatura "+str(Temperatura_C)+"°C, equivale a "+str(Temperatura_F)+"°F"

        alert(title="Temperatura: De °C A °F", message=mensaje)
    ...
    def btn_convertir_f_c_on_click(self):
        ...
        mensaje = "La temperatura "+str(Temperatura_F)+"°F, equivale a "+str(Temperatura_C)+"°C"

        alert(title="Temperatura: De °F A °C", message=mensaje)
