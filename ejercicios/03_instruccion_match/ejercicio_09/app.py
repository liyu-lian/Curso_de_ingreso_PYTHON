...
class App(customtkinter.CTk):
    ...
    def btn_informar_on_click(self):
        estacion_del_año = self.combobox_estaciones.get()
        ...
        importe_final = precio_viaje + aumento - descuento

        mensaje = "El precio final con su respectivo aumento/descuento es: "+str(importe_final)
